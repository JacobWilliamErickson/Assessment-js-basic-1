...
Y8PPPPPP 888oo888 888oo888   88oop' `)
    ...
    console.log(`Password is not long enough ${password.length}/10 required or does not contain both numbers and letters`)
    console.log(`d88PPPo ,8b.     88PPP. 
888ooo8 88'8o    88   8 
888   8 88PPY8.  88   8 
888PPPP 8b   Y'  88oop'`)
...
//else statement to give the password is too long message
    ...
    console.log(`Password is too long ${password.length}/30 maximum or does not contain both numbers and letters`)
    console.log(`d88PPPo ,8b.     88PPP. 
888ooo8 88'8o    88   8 
888   8 88PPY8.  88   8 
888PPPP 8b   Y'  88oop'`)
